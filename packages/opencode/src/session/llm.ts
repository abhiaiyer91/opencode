...
export namespace LLM {
  ...
  export async function stream(input: StreamInput) {
    ...
    return streamText({
      ...
      // Cast to work around @ai-sdk/provider version mismatch between AI SDK versions
  ...
  /**
   * Convenience function that wraps stream for simple callers.
   * Alias for stream() to maintain backwards compatibility.
   */
