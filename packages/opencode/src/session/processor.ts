...
export namespace SessionProcessor {
  ...
  export function create(input: {
    ...
    const result = {
      ...
      async process(streamInput: MastraLLM.StreamInput) {
        log.info("process")
        ...
        while (true) {
          try {
            if (isMastra) {
              // Use Mastra agent for streaming
              const prepared = await MastraLLM.prepare(streamInput)
              log.info("prepared (mastra)", {
              ...
              await MastraLLM.processStream(stream, {
                ...
                state: {
                  ...
                  setSnapshot: (s: string | undefined) => {
                    snapshot = s
                  },
              ...
              // Use upstream LLM implementation
